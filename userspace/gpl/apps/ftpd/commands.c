...
//<<  [CTFN-NMIS-012] Charles Wei, Add file renaming in FTP storage
#ifdef SUPPORT_FTPD_STORAGE
// brcm not needed
//#if 0 //<== remove since we need it; work with [CTFN-NMIS-012]
