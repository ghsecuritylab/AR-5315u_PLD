...
// patch2
int ses_retries=8;
//<< [BCMBG-NTWK-078] Antony.Wu : Close the raw socket for interrupt blocking issue and for preventing CPE from being hanged by ppp_client, 20120531
// << asdrick : fix TLF pixelating with interrupt blocking issue 2008/10/03
extern int disc_sock;
// >> asdrick : end, fix TLF pixelating with interrupt blocking issue 2008/10/03
//>> [BCMBG-NTWK-078] End
