...
typedef struct
{
    ...
    UBOOL8    X_COMTREND_COM_WanReset;	/**< X_COMTREND_COM_WanReset */
 ...
 *
 * MDMOID_NS_LOOKUP_DIAG_RESULT 52
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
    ...
    char *    IPAddresses;	/**< IPAddresses */
    char *    DNSServerIP;	/**< DNSServerIP */
    UINT32    responseTime;	/**< ResponseTime */
} NsLookupDiagResultObject;

/*! \brief _NsLookupDiagResultObject is used internally to represent NsLookupDiagResultObject */
typedef NsLookupDiagResultObject _NsLookupDiagResultObject;



/*! \brief Obj struct for InternetGatewayDevice.IPPingDiagnostics.
 *
 * MDMOID_IP_PING_DIAG 53
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_LAN_IP_INTF_FIREWALL_EXCEPTION 61
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_DHCP_CONDITIONAL_SERVING 63
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_STATIC_I_PV6_NEIGHBOR 71
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_LAN_WLAN_ASSOCIATED_DEVICE_ENTRY 77
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_LAN_WLAN_PRE_SHARED_KEY 79
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_LAN_MOCA_INTF_STATUS 94
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_COMMON_INTF_CFG 101
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_XTM_INTERFACE_STATS 102
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
...
#endif
    UBOOL8    X_COMTREND_COM_ADSL_AutoReLink_Enabled;	/**< X_COMTREND_COM_ADSL_AutoReLink_Enabled */
    SINT32    X_COMTREND_COM_ADSL_AutoReLink_Threshold;	/**< X_COMTREND_COM_ADSL_AutoReLink_Threshold */
    SINT32    X_COMTREND_COM_ADSL_AutoReLink_checkTimer;	/**< X_COMTREND_COM_ADSL_AutoReLink_checkTimer */
#ifdef DMP_X_BROADCOM_COM_ADSLWAN_1
 ...
 *
 * MDMOID_WAN_DSL_INTF_STATS_TOTAL 106
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_DSL_INTF_STATS_SHOWTIME 107
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_DSL_INTF_STATS_CURRENT_DAY 108
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_DSL_INTF_STATS_QUARTER_HOUR 109
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_DSL_TEST_PARAMS 110
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_MOCA_INTF_STATUS 116
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_MOCA_INTF_STATS 117
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_EPON_INTF_STATS 119
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_L2TP_AC_INTF_CONFIG 120
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_PON_INTF_STATUS 122
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_DSL_PROPRIETARY_DIAG 124
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_DSL_DIAG_NON_LINEARITY 126
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_ATM_F4_END_TO_END_LOOPBACK_DIAG 128
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_ATM_F4_LOOPBACK_DIAG 129
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_ATM_F5_END_TO_END_LOOPBACK_DIAG 130
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_ATM5_LOOPBACK_DIAG 135
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_L2TP_AC_LINK_CONFIG 138
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
...
typedef struct
{
    ...
    UBOOL8    enable;	/**< Enable */
    UBOOL8    reset;	/**< Reset */
    UBOOL8    X_COMTREND_COM_ResetControl;	/**< X_COMTREND_COM_ResetControl */
    ...
    SINT32    X_802dot1q_VlanID;	/**< X_802dot1q_VlanID */
 ...
 *
 * MDMOID_WAN_IP_CONN_PORTMAPPING 141
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_IP_CONN_PORT_TRIGGERING 142
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_IP_CONN_FIREWALL_EXCEPTION 143
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_PPP_CONN_PORT_TRIGGERING 149
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_PPP_CONN_FIREWALL_EXCEPTION 150
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_L3_FORWARDING_ENTRY 153
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_I_PV6_L3_FORWARDING 154
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_I_PV6_L3_FORWARDING_ENTRY 155
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_CALL_NEW_FLAG 167
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_CALL_NUMBER_OF_MISSED_CALLS 168
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_CALL_DATE_TIME 171
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_CALL_LINE_NAME 172
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_INTERNAL_NAME_LIST 175
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_TERMINAL_NUMBER 176
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_INTERNAL_NAME 177
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_CONTACT_FIRST_NAME 180
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_CONTACT_NUMBER 181
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_CONTACT_MELODY 182
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_CONTACT_LINE_ID 183
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_DECT_SUPPORT_LIST 184
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_PROF_PROVIDER 190
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_PROF_SIP_SUBSCRIBE 192
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_PROF_RTP_SRTP 195
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_LINE_CALLING_FEATURES 199
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_LINE_PROCESSING 200
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_LINE_CODEC_LIST 202
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_LINE_DECT_LINE_ID 206
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_LINE_ATTACHED_HANDSET 207
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_LINE_DIALING_PREFIX 209
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_LINE_BLOCKED_NUMBER 211
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_LINE_MULTI_CALL_MODE 212
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_LINE_INTRUSION_CALL 213
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_LINE_CALL_FORWARDING 215
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_PHY_INTF_TESTS 217
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_DECT_SYSTEM_SETTING 221
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_DECT_PIN_CODE 223
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_DECT_CLOCK_MASTER 224
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_DECT_RESET_BASE 225
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_DECT_FIRMWARE_VERSION 226
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_DECT_HARDWARE_VERSION 227
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_DEBUG_PORT_MIRRORING_CFG 238
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAPI_AS_CERTIFICATE 242
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAPI_ISSUED_CERTIFICATE 243
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_EQUIPMENT_MANAGEMENT 254
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_PORT_MAPPING_PACKAGE_G 262
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GEM_PORT_NETWORK_CTP 266
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GEM_INTERWORKING_TP 267
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MULTICAST_GEM_INTERWORKING_TP 268
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GEM_INTERWORKING_TP_MULTICAST_ADDRESS_TABLE 269
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GEM_PORT_PM_HISTORY_DATA 270
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GAL_ETHERNET_PROFILE 271
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GAL_ETHERNET_PM_HISTORY_DATA 272
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_FEC_PM_HISTORY_DATA 273
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_LAYER2_DATA_SERVICES 274
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MAC_BRIDGE_SERVICE_PROFILE 275
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_BC_MAC_BRIDGE_SERVICE_PROFILE 276
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MAC_BRIDGE_CONFIG_DATA 277
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MAC_BRIDGE_PM_HISTORY_DATA 278
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MAC_BRIDGE_PORT_CONFIG_DATA 279
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MAC_BRIDGE_PORT_DESIGNATION_DATA 280
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MAC_BRIDGE_PORT_FILTER_TABLE_DATA 281
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MAC_BRIDGE_PORT_FILTER_PRE_ASSIGN_TABLE 283
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MAC_BRIDGE_PORT_BRIDGE_TABLE_DATA 284
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MAC_BRIDGE_PORT_PM_HISTORY_DATA 286
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MAPPER_SERVICE_PROFILE 287
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_BC_MAPPER_SERVICE_PROFILE 288
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VLAN_TAGGING_FILTER_DATA 289
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VLAN_TAGGING_OPERATION_CONFIGURATION_DATA 290
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_EXTENDED_VLAN_TAGGING_OPERATION_CONFIGURATION_DATA 291
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_RECEIVED_FRAME_VLAN_TAGGING_OPERATION_TABLE 292
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MULTICAST_OPERATIONS_PROFILE 293
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_DYNAMIC_ACCESS_CONTROL_LIST_TABLE 294
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_STATIC_ACCESS_CONTROL_LIST_TABLE 295
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_LOST_GROUPS_LIST_TABLE 296
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MULTICAST_SUBSCRIBER_CONFIG_INFO 297
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MULTICAST_SUBSCRIBER_MONITOR 298
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_ACTIVE_GROUPS_LIST_TABLE 299
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_BC_MULTICAST_SUBSCRIBER_MONITOR 300
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MULTICAST_SUBSCRIBER 301
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_UPSTREAM_ETHERNET_FRAME_PM_HISTORY_DATA 302
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_DOWNSTREAM_ETHERNET_FRAME_PM_HISTORY_DATA 303
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_LAYER3_DATA_SERVICES 304
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_IP_HOST_CONFIG_DATA 305
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_BC_IP_HOST_CONFIG_DATA 306
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_IP_HOST_PM_HISTORY_DATA 307
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_IPV6_HOST_CONFIG_DATA 308
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_IPV6_CURRENT_ADDRESS_TABLE 309
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_IPV6_CURRENT_DEFAULT_ROUTER_TABLE 310
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_IPV6_CURRENT_DNS_TABLE 311
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_IPV6_CURRENT_ONLINK_PREFIX_TABLE 312
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_BC_IPV6_HOST_CONFIG_DATA 313
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_TCP_UDP_CONFIG_DATA 314
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_ETHERNET_PM_HISTORY_DATA 317
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_ETHERNET_PM_HISTORY_DATA2 318
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_ETHERNET_PM_HISTORY_DATA3 319
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VIRTUAL_ETHERNET_INTERFACE_POINT 320
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_SIP_AGENT_CONFIG_DATA 324
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VO_IP_MEDIA_PROFILE 326
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VO_IP_APP_SERVICE_PROFILE 329
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_FEATURE_ACCESS_CODES 330
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_NETWORK_DIAL_PLAN_TABLE 331
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_CALL_CONTROL_PM_HISTORY_DATA 334
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_RTP_PM_HISTORY_DATA 335
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_SIP_AGENT_PM_HISTORY_DATA 336
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_SIP_CALL_INIT_PM_HISTORY_DATA 337
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MGC_PM_HISTORY_DATA 339
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MOCA_ETHERNET_PM_HISTORY_DATA 346
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MOCA_INTERFACE_PM_HISTORY_DATA 347
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MOCA_INTERFACE_PM_HISTORY_DATA_NODE_TABLE 348
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_TRAFFIC_SCHEDULER_G 351
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GEM_TRAFFIC_DESCRIPTOR 352
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_AUTHENTICATION_SECURITY_METHOD 357
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_TR069_MANAGEMENT_SERVER 362
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_OAMSIP_USR_PARAM_CFG 374
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_OPTICAL_INTERFACE_STATS 387
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
...
/*! \brief _RouteHopObject is used internally to represent RouteHopObject */
typedef RouteHopObject _RouteHopObject;
