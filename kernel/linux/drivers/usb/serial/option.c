...
//<< [CTFN-3G-011] Herbert: Support AT&T USBConnect 900 (Huawei E1815) dongle , 2011/06/28
...
#define ZTE_PRODUCT_MF110_MF190			0x0124
//>> [CTFN-3G-009] End
...
//<< [CTFN-3G-001] MHTsai: Support 3G feature, 2010/08/09
#define BENQ_PRODUCT_H21			0x4512
#define BENQ_PRODUCT_H21_dual			0x4523
#define BENQ_PRODUCT_H20			0x4515
#define BENQ_PRODUCT_H20_dual			0x4518
#define SIMCOMM_VENDOR_ID			0x05C6
#define ONDA_VENDOR_ID                          0x19d2
#define ONDA_PRODUCT_82D                        0x0001
#define ONDA_PRODUCT_83D                        0x0057
#define ZTE_PRODUCT_MF628                       0x0015
#define ZTE_PRODUCT_MF626                       0x0031
#define LONGCHEER_VENDOR_ID			0x1c9e
#define LONGCHEER_PRODUCT_WM66			0x6061
#define TandW_VENDOR_ID				0x2077
#define TandW_PRODUCT_W1U100			0x9000
//>> [CTFN-3G-001] End
//<< [CTFN-3G-010] Dylan: Support Huawei K3765 3G dongle, 2011/05/23
#define HUAWEI_PRODUCT_K3765			0x1465
//>> [CTFN-3G-010] End
//<< [CTFN-3G-012] Dylan: Support Huawei K3770 and K4510 3G dongle, 2011/11/28
...
//<< [CTFN-3G-009] Herbert: Support Huawei E1752C/E1752 and ZTE MF110/MF190 3G dongle, 2011/04/19
	{ USB_DEVICE(ZTE_VENDOR_ID, ZTE_PRODUCT_MF110_MF190) },
//>> [CTFN-3G-009] End, 2011/04/19
	{ USB_DEVICE(ZTE_VENDOR_ID, ZTE_PRODUCT_CDMA_TECH) },
	{ USB_DEVICE(BENQ_VENDOR_ID, BENQ_PRODUCT_H10) },
	{ USB_DEVICE(DLINK_VENDOR_ID, DLINK_PRODUCT_DWM_652) },
	{ USB_DEVICE(0x1da5, 0x4515) }, /* BenQ H20 */
//<< [CTFN-3G-001] MHTsai: Support 3G feature, 2010/08/09
	{ USB_DEVICE(SIMCOMM_VENDOR_ID, 0x6000)}, /* ZTE AC8700 */
	{ USB_DEVICE(SIMCOMM_VENDOR_ID, 0x6613)}, /* Onda H600/ZTE MF330 */
	//{ USB_DEVICE(SIMCOMM_VENDOR_ID, 0x3100)},
	{ USB_DEVICE(BENQ_VENDOR_ID, BENQ_PRODUCT_H21)},
	{ USB_DEVICE(BENQ_VENDOR_ID, BENQ_PRODUCT_H21_dual)},
	{ USB_DEVICE(BENQ_VENDOR_ID, BENQ_PRODUCT_H20)},
	{ USB_DEVICE(BENQ_VENDOR_ID, BENQ_PRODUCT_H20_dual)},
	{ USB_DEVICE(ONDA_VENDOR_ID, ONDA_PRODUCT_82D) },
	{ USB_DEVICE(ONDA_VENDOR_ID, ONDA_PRODUCT_83D) },
	...
	{ USB_DEVICE(TandW_VENDOR_ID, TandW_PRODUCT_W1U100) },
//>> [CTFN-3G-001] End
//<< [CTFN-3G-010] Dylan: Support Huawei K3765 3G dongle, 2011/05/23
					...
					const unsigned char *buf, int count)
{
	...
	usb_fill_bulk_urb(urb, serial->dev,
			  ...
			  buffer, count, option_outdat_callback, port);
...
printk("%s : has one interrupt endpoint\n", __func__);

		result = usb_submit_urb(port->interrupt_in_urb, GFP_ATOMIC); /* GFP_KERNEL -> GFP_ATOMIC*/
		if (result)
						...
						struct usb_serial_port *port)
{
	...
	if (tty) {
		...
		if (serial->num_ports == 1) {
                        printk("%s , num_ports = 1\n", __func__);
			//interface = sierra_calc_interface(serial);
			//interface = serial->interface->cur_altsetting->desc.bInterfaceNumber;
