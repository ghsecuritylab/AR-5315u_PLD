...
UNUSUAL_DEV( 0x1da5, 0xf000, 0x0000, 0x1000,
		"BENQ",
		"Mass Storage",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_benq_h21_init,
		US_FL_IGNORE_DEVICE),
UNUSUAL_DEV(  0x1410, 0x5010, 0x0000, 0x9999,
                "Novatel Wireless",
                "MC950D HSUPA Modem",
                US_SC_DEVICE, US_PR_DEVICE, usb_stor_novatel_mc950d_mc990d_init,
                US_FL_IGNORE_DEVICE),
UNUSUAL_DEV(  0x1410, 0x5020, 0x0000, 0x9999,
                "Novatel Wireless",
                "MC990D HSUPA Modem",
                US_SC_DEVICE, US_PR_DEVICE, usb_stor_novatel_mc950d_mc990d_init,
                US_FL_IGNORE_DEVICE),
UNUSUAL_DEV(  0x19d2, 0x2000, 0x0000, 0x9999,
                "ZTE",
                "HSUPA Modem",
                US_SC_DEVICE, US_PR_DEVICE, usb_stor_zte_mf626_mf628_init,
                US_FL_IGNORE_DEVICE),
UNUSUAL_DEV(  0x1c9e, 0x1001, 0x0000, 0x9999,
                "LONGCHEER HOLDINGS",
                "HSDPA USB MODEM",
                US_SC_DEVICE, US_PR_DEVICE, usb_stor_longcheer_wm66_init,
                US_FL_IGNORE_DEVICE),
UNUSUAL_DEV(  0x2077, 0xf000, 0x0000, 0x9999,
                "T&W",
                "HSDPA USB MODEM",
                US_SC_DEVICE, US_PR_DEVICE, usb_stor_TandW_init,
                US_FL_IGNORE_DEVICE),

//<< [CTFN-3G-009] Herbert: Support Huawei E1752C/E1752 and ZTE MF110/MF190 3G dongle, 2011/04/19
#if 1
UNUSUAL_DEV(  0x19d2, 0x0083, 0x0000, 0x9999,
                "ZTE",
                "HSUPA Modem",
                US_SC_DEVICE, US_PR_DEVICE, usb_stor_zte_mf110_init,
                US_FL_IGNORE_DEVICE),
UNUSUAL_DEV(  0x19d2, 0x0149, 0x0000, 0x9999,
                "ZTE",
                "HSUPA Modem",
                US_SC_DEVICE, US_PR_DEVICE, usb_stor_zte_mf110_init,
                US_FL_IGNORE_DEVICE),
