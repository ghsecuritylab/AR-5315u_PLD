...
// << [CTFN-NMIS-004] jojopo : Port Scan Detect function , 2011/12/02
struct my_share {
   struct semaphore lock;
   struct list_head my_list;
};

static struct my_share share_list;

struct my_share * Get_share_list(void)
{
   return &share_list;
}

EXPORT_SYMBOL_GPL(Get_share_list);
// >> [CTFN-NMIS-004] end
...
// << [CTFN-NMIS-004] jojopo : Port Scan Detect function , 2011/12/02
	init_MUTEX(&share_list.lock);
	INIT_LIST_HEAD(&(share_list.my_list));
// >> [CTFN-NMIS-004] end
