...
static int nf_conntrack_init_init_net(void)
{
	...
	if (!nf_conntrack_htable_size) {
		 ...
		 * entries. */
		max_factor = 4;
printk("[myDBG] max_factor=%d, nf_conntrack_htable_size = %d, original nf_conntrack_max = %d\n", max_factor, nf_conntrack_htable_size, max_factor*nf_conntrack_htable_size);
	}
//	nf_conntrack_max = max_factor * nf_conntrack_htable_size;
	nf_conntrack_max = 16000; /* for PLDT */
